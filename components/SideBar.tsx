...
import {
    UserGroupIcon, ServerIcon, CalendarIcon, ChartSquareBarIcon,
    CogIcon
...
const SideBar = () => {
    return (
        <div className="fixed inset-y-0 left-0 bg-white w-40">
            ...
            h-16 bg-orange-600 text-white font-bold">Alpha version</h1>
            ...
            <ul className="flex flex-col text-lg h-full">
                ...
                <li className="flex justify-center items-center flex-col
                py-7 border-l-4 border-orange-400 text-orange-500
                font-bold">
